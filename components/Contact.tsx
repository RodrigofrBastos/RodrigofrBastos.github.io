...
import { Mail, Github, Linkedin, ChevronRight, Phone, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 flex flex-col md:flex-row items-center justify-between mb-16 shadow-[0_0_40px_rgba(59,130,246,0.3)]">
          <div className="mb-8 md:mb-0">
            <h2 className="text-4xl font-bold text-white mb-2">Looking for a Robotics Engineer?</h2>
            <p className="text-blue-100 font-medium text-lg">I am available for new challenges.</p>
          </div>
          <a 
            href="mailto:digofbastos@gmail.com"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-slate-800 pt-12">
          <div>
            <h4 className="text-2xl font-bold text-white mb-6">RODRIGO <span className="text-primary">BASTOS</span></h4>
            <p className="text-slate-400 leading-relaxed mb-6">
              Passionate Robotics Engineer and Researcher at SENAI CIMATEC. Focused on UAVs, ROS2, and Innovation.
            </p>
        ...
        <div className="text-center text-slate-600 text-sm mt-16">
          &copy; {new Date().getFullYear()} Rodrigo Bastos. All rights reserved.
        </div>
      </div>
    </footer>
  );
