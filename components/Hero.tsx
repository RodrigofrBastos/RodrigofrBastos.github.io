...
import { Terminal, Layers, ChevronDown, Arro } from 'lucide-react';
...
const Hero: React.FC = () => {
  ...
  const words = ["Electrical Engineer", "Roboticist", "UAV Systems Integrator", "Autonomous Systems Developer"];
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-lg md:text-xl max-w-lg leading-relaxed mb-10">
            I build Autonomous Machines. Specializing in UAVs, Robotics, and Embedded Systems to engineer innovative solutions for the world of tomorrow.
          </p>

          {/* Location Timeline (Merged) */}
          <div className="mb-10 w-full max-w-[250px]">
            <div className="group relative bg-slate-800/30 backdrop-blur-md border border-white/5 rounded-full px-6 py-3 flex items-center justify-between hover:border-primary/20 hover:bg-slate-800/50 transition-all duration-500 shadow-lg shadow-black/20">
              ...
              {/* Timeline Content */}
              <div className="flex items-center gap-4 w-full centered justify-between">
                ...
                {/* Current Node */}
                  ...
                  <div className="flex items-center flex-col">
                    <span className="text-white font-bold text-[25px] leading-none">Salvador (BR)</span>
                    <span className="text-[15px] text-primary/80 font-mono uppercase tracking-wider mt-0.5">Current Base</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        >
          ...
          <div className="relative w-[350px] h-[450px] md:w-[450px] md:h-[550px] rounded-[2.5rem] overflow-hidden bg-slate-800 border border-slate-700 shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500 z-10">
            ...
            <div className="absolute bottom-8 left-8 right-8">
              <div className="text-white font-bold text-2xl">Robotics Engineer</div>
              <div className="text-slate-400 text-sm">Engineering the Future</div>
            </div>
          </div>
